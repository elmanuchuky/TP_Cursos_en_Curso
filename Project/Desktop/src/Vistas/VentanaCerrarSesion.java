 ...
 * @author Yasmin
 */
public class VentanaCerrarSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFraseGeneral.setText("¿Desea Cerrar su Sesión?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaCerrarSesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaCerrarSesion().setVisible(true);
            }
        });
    }
