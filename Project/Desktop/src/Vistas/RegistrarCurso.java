...
public class RegistrarCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRegistrar.setBounds(450, 330, 107, 30);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setText("Nombre");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 14, 49, 17);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("Descripcion");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 45, 70, 17);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setText("Temas");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 140, 51, 17);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setText("Costo $");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(250, 280, 50, 17);
        ...
        jLabel8.setBounds(120, 280, 33, 17);
        ...
        jLabel10.setBounds(390, 280, 29, 17);

        txtNombre.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(txtNombre);
        txtNombre.setBounds(90, 11, 470, 23);
        ...
        cmbMes1.setBounds(410, 230, 58, 23);

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel12.setText("/");
        getContentPane().add(jLabel12);
        jLabel12.setBounds(470, 230, 8, 17);

        cmbDia.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(cmbDia);
        cmbDia.setBounds(340, 230, 54, 23);

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel13.setText("/");
        getContentPane().add(jLabel13);
        jLabel13.setBounds(400, 230, 8, 17);
        ...
        cmbMinutos.setBounds(500, 280, 60, 23);

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel15.setText("Duracion en Semanas");
        getContentPane().add(jLabel15);
        jLabel15.setBounds(10, 230, 140, 17);
        ...
        jLabel17.setBounds(120, 0, 500, 370);

        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FondoRegistrar.jpg"))); // NOI18N
        jLabel18.setText("jLabel16");
        getContentPane().add(jLabel18);
        jLabel18.setBounds(0, 0, 180, 370);
